            ...
            <div className="flex flex-col lg:flex-row gap-16">
              ...
              <div className="w-full lg:w-2/3">
                <div className="bg-white p-8 rounded-xl shadow-sm">
                  <h2 className="text-2xl font-bold mb-6 text-[#054A40]">
                    Send Us a Message
                  </h2>
                  <Form {...form}>
                    <form
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-[#54595F]">
                                Your Name
                              </FormLabel>
                              <FormControl>
                                <Input
                      ...
                      <Button
                        type="submit"
                        className="w-full rounded-full bg-[#054A40] hover:bg-[#054A40]/90"
                      >
              ...
              <div className="w-full lg:w-1/3">
                <div className="space-y-6">
                  <div className="bg-[#FEFBF6] p-8 rounded-xl shadow-sm">
                    <h3 className="text-xl font-bold mb-6 text-[#054A40]">
                      Contact Information
                    </h3>
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <a
                            ...
                            className="text-[#54595F] hover:text-[#054A40]"
                          >
                            hello@astralis.com
                          </a>
                        </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div>
                          <p className="font-medium text-[#054A40]">
                            Our Office
                          </p>
                  ...
                  <div className="bg-[#054A40] p-8 rounded-xl text-white shadow-sm">
                    ...
                    <p className="mb-6">
                      Check out our comprehensive help center for frequently
                      asked questions and detailed guides.
                    </p>
                    <Button
                      asChild
                      variant="secondary"
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="aspect-video w-full rounded-xl overflow-hidden shadow-md">
              ...
              <div className="w-full h-full">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3670.458872451148!2d72.49309467400278!3d23.080292214174214!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e9d8f9ac3ec17%3A0xf955692e13272fcf!2sScience%20City%20Ahmedabad!5e0!3m2!1sen!2sin!4v1709254849996!5m2!1sen!2sin"
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 text-[#054A40]">
            ...
            <div className="space-y-6">
              <div className="bg-[#FEFBF6] rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-2 text-[#054A40]">
                  What's the fastest way to get help?
                </h3>
                <p className="text-[#54595F]">
                  For immediate assistance, we recommend checking our support
                  center first. For technical issues, email support is typically
                  the fastest route. For urgent matters, please call our support
                  line.
                </p>
              </div>
              ...
              <div className="bg-[#FEFBF6] rounded-xl p-6">
                ...
                <p className="text-[#54595F]">
                  ...
                  days. Phone support is available during our business hours,
                  and chat support typically has wait times under 5 minutes.
                </p>
              </div>
              ...
              <div className="bg-[#FEFBF6] rounded-xl p-6">
                ...
                <p className="text-[#54595F]">
                  While our office is closed on weekends, Premium and Business
                  plan customers have access to emergency support for critical
                  issues via our priority email channel.
                </p>
              </div>
              ...
              <div className="bg-[#FEFBF6] rounded-xl p-6">
                ...
                <p className="text-[#54595F]">
                  You can use the contact form above with the reason set to
                  "Product Feedback" or email us directly at
                  feedback@Astralis.com. We value your input and review all
                  suggestions!
                </p>
              </div>
            </div>
