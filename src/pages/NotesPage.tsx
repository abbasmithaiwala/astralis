...
import { Search, Grid3X3, List, MessageSquare, Menu } from 'lucide-react';
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    if (searchQuery.trim()) {
      try {
        ...
        setIsSearching(true);
        setShowSearchBox(false); // Hide search box after searching on mobile
      } catch (error) {
      ...
      `}>
        <div className="p-4 sm:p-6">
          ...
          <div className="flex flex-col gap-4 mb-6">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Button
                  variant="outline"
                  size="icon"
                  className="h-10 w-10 flex items-center justify-center shrink-0 sm:hidden"
            ...
            {/* Search form that expands in mobile */}
            <form 
              onSubmit={handleSearch} 
              className={`
                flex gap-2 w-full transition-all duration-300
                ${showSearchBox || window.innerWidth >= 640 ? 'max-h-12' : 'max-h-0 sm:max-h-12 overflow-hidden'}
              `}
            >
              <Input
                type="text"
                ...
                className="w-full border-[#E5DCC3]/30 focus-visible:ring-1 focus-visible:ring-[#054A40] focus-visible:ring-offset-0 focus-visible:border-[#054A40]"
              />
              <Button 
                type="submit" 
                size="icon" 
          ...
          {/* Notes grid/list with responsive styling */}
