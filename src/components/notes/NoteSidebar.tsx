      ...
      >
        <div className="flex flex-col h-full overflow-y-auto">
              ...
              {navLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className={cn(
                      "flex items-center px-4 py-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-[#FCA591]/10 dark:hover:bg-[#FCA591]/20 transition-colors duration-200",
                      isActive(link.path) && "bg-[#FCA591]/20 dark:bg-[#FCA591]/30 text-[#FCA591] dark:text-[#FCA591] font-medium"
                    )}
                  >
                  ...
                  {tags.map((tag) => (
                    <li key={tag}>
                      <Link
                        ...
                        className={cn(
                          "flex items-center px-4 py-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-[#FCA591]/10 dark:hover:bg-[#FCA591]/20 transition-colors duration-200",
                          isActive(`/notes/tags/${tag}`) && "bg-[#FCA591]/20 dark:bg-[#FCA591]/30 text-[#FCA591] dark:text-[#FCA591] font-medium"
                        )}
                      >
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-800">
            <Link
              to="/settings"
              className="flex items-center px-4 py-2 rounded-md text-gray-700 dark:text-gray-300 hover:bg-[#FCA591]/10 dark:hover:bg-[#FCA591]/20 transition-colors duration-200"
            >
              <span className="mr-3">
